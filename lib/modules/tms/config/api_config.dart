...
class ApiConfig {
  ...
  static Future<bool> get hasEmptyBaseUrl async{
    String baseUrl = _cachedBaseUrl??"";
    return _defaultBaseUrl.trim().isNotEmpty;
  }
  static Map<String,String> authHeaders(String token) {
    _headers = {"Authorization":"Beaver $token"}; 
    //TODO: add auth Header method here
    return _headers??{};
  }
